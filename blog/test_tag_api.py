...
class TagApiTestCase(LiveServerTestCase):
    def setUp(self):
        get_user_model().objects.create_user(
            email="saadalsaad00@gmail.com", password="2111996sd"
        )
    ...
    def test_tag_create_basic_auth(self):
        self.client.auth = HTTPBasicAuth("saadalsaad00@gmail.com", "2111996sd")
    ...
    def test_tag_create_token_auth(self):
        token_resp = self.client.post(
            ...
            {"username": "saadalsaad00@gmail.com", "password": "2111996sd"},
        )
